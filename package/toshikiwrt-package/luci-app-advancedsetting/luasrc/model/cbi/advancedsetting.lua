...
m = Map("advancedsetting", translate("Advanced Setting"))
m.description = translate("Direct editing of built-in Script Documents for various services, unless you know what you are doing, do not easily modify these configuration documents")
