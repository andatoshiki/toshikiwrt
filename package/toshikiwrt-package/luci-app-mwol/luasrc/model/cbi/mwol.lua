...
m.description = translate("请关注微信公众号【WiFi物联网】获取更多信息: \<a href=\"http://www.mleaf.org/downloads/logo/201911171573997716658567.jpg\" target=\"_blank\">【WiFi物联网】</a>")
...
host.description = translate("Choose the host to wake up or enter a custom MAC address to use")
...
cafile.description = translate("Edit the ca file path.")
...
crtfile.description = translate("Edit the crt file path.")
...
keyfile.description = translate("Edit the key file path.")
